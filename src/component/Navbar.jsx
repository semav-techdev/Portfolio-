    ...
    return (
        <>
            ...
            <div className={`md:hidden absolute flex flex-col items-center gap-4 z-[1002] top-[55%] text-textColor bg-blureBackground shadow-md 
                ...
                <Link onClick={() => setMenuOpen(false)} className="hover:text-hoverColor" to="/">Home</Link>
                <Link onClick={() => setMenuOpen(false)} className="hover:text-hoverColor" to="/about">About Me</Link>
                <Link onClick={() => setMenuOpen(false)} className="hover:text-hoverColor" to="/projects">My Projects</Link>
                <Link onClick={() => setMenuOpen(false)} className="hover:text-hoverColor" to="/contact">Contact</Link>
            </div>
